...
internal static class LocalizationRegistry
{
    ...
    public static Dictionary<string, (string En, string Ko)> Build()
    {
        return new Dictionary<string, (string En, string Ko)>
        {
            ...
            [StringKeys.Search.Detail.NotIndexed] = ("File not yet indexed", "아직 인덱싱되지 않은 파일"),
            [StringKeys.Search.Detail.PreviewError] = ("Unable to load preview", "미리보기를 불러올 수 없습니다"),
            ...
            [StringKeys.SmartNote.OpenedLastWeek] = ("Opened 1–2 weeks ago", "1~2주 전 열어봄"),
            [StringKeys.SmartNote.OpenedLastMonth] = ("Opened 2 weeks–2 months ago", "2주~2개월 전 열어봄"),
            ...
            [StringKeys.SmartNote.ModifiedThisWeek] = ("Modified in last 7 days", "최근 7일 내 수정"),
            [StringKeys.SmartNote.ModifiedThisMonth] = ("Modified in last 30 days", "최근 30일 내 수정"),
